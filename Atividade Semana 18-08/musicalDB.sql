...
INSERT INTO `musicos` VALUES (1,'Geddy Lee','Gary Lee Weinrib','Baixo'),(2,'Alex Lifeson','Aleksandar Živojinović','Guitarra'),(3,'Neil Peart','Neil Ellwood Peart','Bateria'),(4,'Keith Emerson','Keith Noel Emerson','Teclado'),(5,'Greg Lake','Gregory Stuart Lake','Guitarra'),(6,'Carl Parlmer','Carl Frederick Kendall Palmer','Bateria'),(7,'Riche Kotzen','Richard Dale Kotzen Jr.','Guitarra'),(8,'Billy Sheehan','William Sheehan','Baixo'),(9,'Mike Portnoy','Michael Stephen Portnoy','Bateria'),(10,'Jeff Scott Soto','Jeff Scott Soto','Vocal'),(11,'Derek Sherinian','Derek Sherinian','Teclado'),(12,'Ron \"Bumblefoot\" Thal','Ronald Jay Blumenthal','Guitarra');
...
-- Dump completed on 2020-08-27  8:43:37
